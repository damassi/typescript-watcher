...
/**
 * Checks if config.json exists and populates the config object
 * @type {Object}
 */
var _jsonConfig = {};
 ...
 * 
 */
function _readJSONSettings() {
	_jsonConfig = JSON.parse( fs.readFileSync( sysPath.join( __dirname, '..', '..', 'config.json' )));
}
 ...
 * 
 */
function _setupCommandLineInterface() {
